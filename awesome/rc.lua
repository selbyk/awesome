...
config_dir = ("/home/selby/.config/awesome/")
...
tags = {
 ...
 layout = {
      layouts[2],  -- 1:float windows
      layouts[6],   -- 2:chat
      layouts[10],   -- 3:ide
      layouts[10],  -- 4:chrome
      layouts[10],   -- 5:text editor
      layouts[6],  -- 6:terminal
          }
       }
  for s = 1, screen.count() do
...
local strf = '<span font="ProgmataPro 11" color="#EEEEEE" background="#777E76">%b %d %I:%M</span>'
...
vicious.register(netwidget, vicious.widgets.net, function(widget, args)
    ...
    return '<span background="#D0785D" font="ProgmataPro 11"> <span font ="ProgmataPro 11" color="#FFFFFF">'..args["{"..interface.." down_kb}"]..'kbps'..'</span></span>' end, 10)
...
vicious.register( batwidget, vicious.widgets.bat, '<span background="#92B0A0" font="ProgmataPro 11"><span font="ProgmataPro 11" color="#FFFFFF" background="#92B0A0">$1$2% </span></span>', 30, "BAT0" )
...
'<span background="#D0785D" font="ProgmataPro 11"> <span font="ProgmataPro 11" color="#EEEEEE">${/home/selby used_p}/${/home/selby avail_p} GB </span></span>', 800)
...
'<span background="#4B3B51" font="ProgmataPro 11"><span font="ProgmataPro 11" color="#EEEEEE"> Vol:$1 </span></span>', 0.3, "Master")
...
'<span background="#4B696D" font="ProgmataPro 11"> <span font="ProgmataPro 11" color="#DDDDDD">$2%<span color="#888888">·</span>$3% </span></span>', 5)
...
vicious.register(memwidget, vicious.widgets.mem, '<span background="#777E76" font="ProgmataPro 11"> <span font="ProgmataPro 11" color="#EEEEEE" background="#777E76">$2MB </span></span>', 20)
...
for s = 1, screen.count() do
    ...
    -- Create the bottom wibox
     myinfowibox = awful.wibox({ position = "bottom", screen = s, height = "11" })

   -- Widgets that are aligned to the bottom
    local bottom_layout = wibox.layout.align.horizontal()
    bottom_layout:set_left(mytasklist[s])

    myinfowibox:set_widget(bottom_layout)
end
-- }}}
...
awful.rules.rules = {
    ...
    { rule = { name = ". - Sublime Text" },
      properties = { border_width = "0" },
      callback = function (c) awful.client.movetotag(tags[mouse.screen][4], c) end },
    { rule = { name = "Spotify ." },
      properties = { border_width = "0" },
      callback = function (c) awful.client.movetotag(tags[mouse.screen][6], c) end },
    { rule = { instance = "plugin-container" },--Fix bug with youtube
     properties = { floating = true } },
    { rule = { instance = "exe" }, -- Fix bug with Chromium
     properties = { floating = true } },
